...
export default function Blog() {
    ...
    return (
        <div className="blog flex flex-col items-center justify-center relative">
                ...
                <div className="absolute left-0 top-0 w-full h-48 bg-black/50 flex flex-col items-center justify-center text-white">
                    ...
                    <div className="flex justify-center w-full mt-2">
                        <div className="flex items-center">
                            ...
                            <span className="text-pink-600">Blog</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="articles flex flex-col items-center justify-center mx-auto max-w-7xl w-full px-0 lg:px-8 py-6">
